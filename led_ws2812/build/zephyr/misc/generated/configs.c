...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_CC312_SW_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_WORLDSEMI_WS2812_SPI_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_CMAKE_BUILD_TYPE_DEBUG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_TFM, 0x10000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LED_STRIP_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LED_STRIP_LOG_LEVEL, 4);
